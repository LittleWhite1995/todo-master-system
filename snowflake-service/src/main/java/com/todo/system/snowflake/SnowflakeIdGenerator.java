 ...
 * @description: SnowflakeIdGenerator(TODO Twitter的分布式自增ID算法snowflake)
 * @author: littleWhite
 * @create: 2019/6/10 11:27
 **/
public class SnowflakeIdGenerator {
    ...
    public static void main(String[] args) {
        SnowflakeIdGenerator idWorker = new SnowflakeIdGenerator(3, 7);
